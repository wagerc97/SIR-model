...
def librarySolver(solverChoice, t_0, ndays, t, S_0, I_0, R_0, beta, gamma, omichron):
    """
    ...
    if solverChoice == 1:
        ...
        solution = scipy.integrate.odeint(
            ...
            t=t,                  # time points
            args=(beta, gamma, omichron)    # rates
        )
    elif solverChoice == 2:
...
if __name__ == '__main__':
    ...
    solverChoice = 2
    solution = np.array(librarySolver(solverChoice, t_0, ndays, t, S_0, I_0, R_0, beta, gamma, omichron))
